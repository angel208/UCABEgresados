...
app.post('/egresado_votacion', requireLogin, function(req, res) {
...
app.get('/egresados-registroNuevo', function(req, res) {
    ...
    res.render('egresados-registro-nuevo');
...
app.get('/egresado-registro-2/:CI', function(req, res) {
    ...
    con.query(" SELECT DE.CIEgresado,concat_ws(' ',eg.NombreEgresado,eg.ApellidoEgresado) as nombre, DE.Correoucab, DE.AnoEgreso "
        ...
        +" AND DE.CIegresado=eg.CI;", function (err, result, fields){
...
//******************************************************************//
//post PARA REGISTRO USUARIO PASO 4//
//******************************************************************//
...
app.post('/registro-egresado4', function(req, res) {
    ...
    if(pass == pass2)
    {
        ...
        con.query("INSERT INTO `ucabegresados`.`usuario` (`NombreUsu`, `ClaveUsu`, `Cargo`) "
            +" VALUES ('"+usu+"', '"+pass+"', '3');", function (err, result, fields){

            con.query("UPDATE egresado SET `preguntaSeg`='"+preg+"', `respuestaSeg`='"+resp+"' "
                +" WHERE `CI`='"+CI+";"
                , function (err, result, fields){
...
app.post('/updateEgre', function(req, res) {
    ...
    con.query("UPDATE egresados SET `Tlf`='"+tlf+"', "
